...
import { checkCall, isObj, isEmptyColl } from 'jsutils'
...
export const useStyles = (stylesCb, customStyles) => {
  ...
  const styles = !customStyles || !isObj(customStyles) || isEmptyColl(customStyles)
    ? false
    : customStyles
  ...
  return useMemo(() => checkCall(stylesCb, theme, styles), [ theme, stylesCb, styles ])
}
